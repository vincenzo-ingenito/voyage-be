...
public class GroupTravelController implements IGroupTravelCtl {
    ...
    public ResponseEntity<ParticipantDTO> updateParticipantRole(Long travelId, String userId, ParticipantRole newRole, CustomUserDetails userDetails) {
        ...
        ParticipantDTO participant = groupTravelService.updateParticipantRole(
            travelId,
            userId,
            newRole,
    ...
    public ResponseEntity<Void> removeParticipant(
        ...
        groupTravelService.removeParticipant(
            travelId,
            userId,
            userDetails.getUserId()
        );
    ...
    @Override
    public ResponseEntity<List<ParticipantDTO>> getMyGroupTravelParticipations(
            CustomUserDetails userDetails) {
