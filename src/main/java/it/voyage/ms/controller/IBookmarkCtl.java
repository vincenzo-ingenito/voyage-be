...
public interface IBookmarkCtl {
	...
	@Operation(summary = "Aggiungi un viaggio ai segnalibri", description = "Permette all'utente di salvare un viaggio nei propri segnalibri")
	@ApiResponses(value = {
	...
	@Operation(summary = "Rimuovi un viaggio dai segnalibri", description = "Rimuove un viaggio salvato dai segnalibri dell'utente")
	@ApiResponses(value = {
	...
	@Operation(summary = "Ottieni tutti i segnalibri dell'utente", description = "Restituisce la lista di tutti i viaggi salvati dall'utente nei segnalibri")
	@ApiResponses(value = {
	...
	@Operation(summary = "Verifica se un viaggio è salvato nei segnalibri", description = "Controlla se l'utente ha salvato un determinato viaggio nei segnalibri")
	@ApiResponses(value = {
